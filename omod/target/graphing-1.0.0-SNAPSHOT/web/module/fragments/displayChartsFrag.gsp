...
<div id="i${i}" class="s1">
             <% if (chartInfos.get(i).chartTypeName.equals("graph") || chartInfos.get(i).chartTypeName.equals("bmi")){ %>
...
function refreshAllGraphCharts() {
    ...
    <% chartInfos.each { chartInfo ->%>
        chartNum++;
        <% if (chartInfo.chartTypeName.equals("graph") || chartInfo.chartTypeName.equals("bmi")){ %>
      ...
      yAxes: [{
        ...
        ticks: {
            ...
            graphChart.data.labels = [startDate, endDate]
                ...
                <% chartInfo.graphChart.allLineChartInfos.each { lineChartData ->%>
                    ...
                    dataset = {
                        ...
                        dataset.backgroundColor = "${lineChartData.color}";
                        dataset.borderColor     = "${lineChartData.color}";
                        <% lineChartData.dataPoints.each { dataPoint ->%>
                            date = "${dataPoint.date}";
                        ...
                        dataset.label = "${lineChartData.lineName}";                    
